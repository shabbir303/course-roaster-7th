...
//     // Show data regardless of single or double click
//     handleDetail(course);
//     handletime(credit_hour);
//     handleTotal(price);
//   };
...
//     // Show toast only on double-click
//     toast("Button double-clicked!");
//   };

//   return (
//     <div className="bg-white items-center rounded-xl">
//       <img src={image} className="w-[90%] mx-auto mt-[15px]" />
//       <h1 className="w-[90%] mx-auto text-[18px] font-[600] text-black my-4">
//         {title}
//       </h1>
//       <h1 className="w-[90%] mx-auto text-[14px] font-[400] text-[#0f0f0f99]">
//         {description}{" "}
//       </h1>
//       <div className="flex justify-between w-[90%] mx-auto text-[#1C1B1B99] text-[16px] font-[500] mt-[10px]">
//         <div className="flex justify-evenly">
...
//         className="w-[90%] mx-auto bg-[#2F80ED] flex justify-center items-center py-[5px] my-[15px] rounded-lg text-white text-[18px] font-[500]"
//       >
//         Select
//       </button>
//       <ToastContainer />
